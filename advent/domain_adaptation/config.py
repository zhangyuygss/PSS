...
# Directories
cfg.DATA_DIRECTORY_SOURCE = "/disk1/datasets/VOCdevkit/VOC2012"
...
cfg.TRAIN.LEARNING_RATE = 2.5e-3
...
cfg.TEST.SAVE_PRED = False

cfg.TEST.EXT = ''
cfg.TEST.ENTRANK = False
cfg.TEST.FULLMAP = False
